// src/components/MaleFatLoss.jsx
...
const program = {
  ...
  overview:
    "Targeted recomposition plan to drop fat and enhance muscle definition using strength training and metabolic conditioning. Balanced nutrition with refeeds and recovery emphasis.",
  split: "4 strength + 2 metabolic conditioning sessions / week",
  nutrition:
    "Slight calorie deficit, higher protein, carb cycling around workouts, and fiber-rich foods to support satiety and recovery.",
  sampleDay:
    "Breakfast: Veg omelet + oats • Lunch: Grilled fish + salad • Snack: Nuts & fruit • Dinner: Chicken stir-fry + veggies",
  expected:
    "Reduce body fat percentage, improved muscle definition, better conditioning and sustained energy.",
  hero:
...
export default function MaleFatLoss() {
  const plans = [
    {
      key: "1m",
      label: "1 Month Plan",
      ...
      perks: ["Weekly coaching", "Access to conditioning templates", "Weekly check-ins"],
    },
    {
      key: "6m",
      label: "6 Month Plan",
      ...
      perks: ["Bi-weekly programming", "Nutrition check-ins", "Progress photos & adjustments"],
    },
    {
      key: "12m",
      label: "12 Month Plan",
      ...
      perks: ["Monthly 1-on-1", "Priority programming", "Supplement & recovery guidance"],
    },
  ];
  ...
  return (
    <main className="px-4 sm:px-6 lg:px-8 py-8 max-w-5xl mx-auto bg-gradient-to-b from-pink-50 via-rose-50 to-white rounded-3xl shadow-inner mt-25">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        {/* RIGHT: Stacked plans on small/medium */}
        <aside className="bg-white rounded-2xl shadow-md p-6 border border-rose-100">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Pick 1, 6 or 12 month plan. Longer plans include discounts and added perks.
          </p>
          ...
          <div className="mt-4 text-xs text-gray-500">
            <p>Prices indicative. Contact for personalized or group plans.</p>
          </div>
        </aside>
