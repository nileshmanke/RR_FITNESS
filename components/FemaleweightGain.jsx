// src/components/FemaleWeightGain.jsx
...
const program = {
  ...
  overview:
    "Designed for women aiming to gain healthy weight and lean muscle through progressive resistance training, smart calorie surplus and recovery-focused programming.",
  split: "4 sessions: Push, Pull, Legs, Glutes/Accessory",
  nutrition:
    "Slight calorie surplus (+300 kcal), emphasis on protein and complex carbs, portion control and nutrient timing for muscle growth.",
  sampleDay:
    "Breakfast: Eggs + toast • Lunch: Rice + lentils + veggies • Snack: Protein shake + almonds • Dinner: Chicken + quinoa",
  expected:
...
export default function FemaleWeightGain() {
  const plans = [
    {
      key: "1m",
      label: "1 Month Plan",
