// src/components/FemaleWeightLoss.jsx
...
const program = {
  ...
  duration: "12 weeks",
  overview:
    "A holistic weight-loss program tailored for women — low-impact strength, metabolic conditioning, and balanced nutrition focused on hormone support and sustainable results.",
  split: "3 strength + 2 cardio + 1 mobility session / week",
  nutrition:
    "High-protein, nutrient-dense meals with focus on hormone balance, fiber and consistent meal timing. Healthy deficits and planned refeeds.",
  sampleDay:
    "Breakfast: Smoothie bowl • Lunch: Grilled paneer wrap • Snack: Nuts & fruit • Dinner: Lentil soup + salad",
  expected:
    "3–6 kg reduction (varies by start point), improved energy, better posture and visible toning.",
  hero:
...
export default function FemaleWeightLoss() {
  const plans = [
    {
      key: "1m",
      label: "1 Month Plan",
      ...
      perks: ["Weekly check-ins", "Guided workouts", "Meal templates"],
    },
    {
      key: "6m",
      label: "6 Month Plan",
      ...
      perks: ["Bi-weekly coaching", "Customized meal plan", "Progress tracking"],
    },
    {
      key: "12m",
      label: "12 Month Plan",
      ...
      perks: ["Monthly 1-on-1", "Priority support", "Complete lifestyle plan"],
    },
  ];
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <aside className="bg-white rounded-2xl shadow-md p-6 border border-rose-100">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Pick 1, 6 or 12 month plan. Longer plans include discounts and more coaching time.
          </p>
          ...
          <div className="mt-4 text-xs text-gray-500">
            <p>Prices indicative. Contact for personalized options.</p>
          </div>
        </aside>
